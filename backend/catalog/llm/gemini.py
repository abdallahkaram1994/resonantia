...
class GeminiLLM:
    """Query parsing (SPEC section 7.1 step 3), via Gemini's structured output: the response is
    constrained to `_RESPONSE_SCHEMA` at the API level, and independently validated again here,
    since a provider's output is never trusted blindly."""
